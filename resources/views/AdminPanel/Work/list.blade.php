    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('work.create') }}" type="button" value="Add" class="btn btn-success float-right">Add</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        @if ($work)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('work.edit', [$value->id]) }}" class="btn btn-app-sm bg-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('work.destroy', [$value->id]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
