            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('work.update', [$work->id]) }}" enctype="multipart/form-data" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                @enderror
                                <img src="{{ asset('uploads/' . $work->image) }}" alt="" class="p-2" id="previewImg" height="200px" width="200px">
                                <hr>
